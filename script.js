...
async function fetchData() {
  try {
    ...
    const catRes = await fetch(
      'https://docs.google.com/spreadsheets/d/1_WfhwsyIiCOx5Sq2pikBEFEFtjoH0r_AlqNd-vN0ci0/gviz/tq?sheet=Категории&tqx=out:json'
    );
    ...
    const prodRes = await fetch(
      'https://docs.google.com/spreadsheets/d/1_WfhwsyIiCOx5Sq2pikBEFEFtjoH0r_AlqNd-vN0ci0/gviz/tq?sheet=Товары&tqx=out:json'
    );
