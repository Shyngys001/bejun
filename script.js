     ...
     function checkout() {
         ...
         const phone = '77020075568';
         let text = '*🛒 Новый заказ с Be Junior Store*\n\n';
         ...
         state.cart.forEach((item, index) => {
             ...
             cartItem.innerHTML = `
                 ...
                 <div class="cart-item-details">
                     ...
                     ${item.color ? `<p class="cart-item-color">Цвет: ${item.color}</p>` : ''}
     ...
     function setupEventListeners() {
         ...
         document.addEventListener('click', (e) => {
             ...
             if (e.target.classList.contains('add-to-cart-modal')) {
                 ...
                 if (product.colors.length > 0 && !selColor) {
                 ...
                 addToCart(
                     productId,
                     selSize ? selSize.dataset.size : '',
                     selColor ? selColor.dataset.color : ''
                 );
     ...
     document.getElementById('contact-form').addEventListener('submit', function(e) {
         ...
         let text = '*📩 Новая заявка Be Junior Store*%0A%0A';
